...
plot(hpc_data$DateTime, hpc_data$Global_active_power, type = "l",
     xlab = "", ylab = "Global Active Power (Kilowatts)")
dev.off()

#checking the weekdays for the dates on plot2 axis 
weekdays(as.Date("2007-02-01"))
weekdays(as.Date("2007-02-02"))

png("plot2.png", width = 480, height = 480)

#plotting with manually set x axis labels
plot(hpc_data$DateTime, hpc_data$Global_active_power, type = "l",
     xlab = "", ylab = "Global Active Power (Kilowatts)", 
